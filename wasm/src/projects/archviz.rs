...
pub async fn archviz() {
    ...
    loader
        .set_attribute("src", "/api/projects/archviz/Build/UnityLoader.js?ver=nMuDpQ-AYpEWInSHYdKQCPirHqc")
    ...
    progress
        .set_attribute("src", "/api/projects/archviz/TemplateData/UnityProgress.js?ver=RbntRCLuTjKnJ7JYyemIwqsnzf8")
    ...
    instance.set_inner_html(
        "var unityInstance;
                function unityInitializer() {
                    ...
                    \"unityContainer\", 
                    \"/api/projects/archviz/Build/WebGLBuild.json?ver=yUHErihJ4lcCuKGlhvq9deDwKhk\", 
